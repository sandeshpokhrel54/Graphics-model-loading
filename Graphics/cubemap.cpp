...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("texcubes.vs", "texcubes.fs");
...
//other cubes vertices and texture coordinate data
    float vertices[] = {
...
//.........................cubemap texture........
    ...
    unsigned char *data = stbi_load("./resources/bricktex.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    // load image, create texture and generate mipmaps
    data = stbi_load("./resources/af.png", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
            ...
            float angle = 20.0f * i;
            model = glm::rotate(model, glm::radians(angle*10*sin(glm::radians((float)glfwGetTime()))), glm::vec3(1.0f, 0.3f, 0.5f));
